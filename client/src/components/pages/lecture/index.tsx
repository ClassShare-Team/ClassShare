...
function StartTimePicker() {
  ...
  return (
    <StartTimePickerWrapper>
      <StartTimeButton type="button" onClick={() => setOpen(!open)}>
        {date && hour && minute
      ...
      {open && (
        <StartTimeDropdown ref={ref}>
          <div>
            ...
            <StartTimeInput type="date" value={date} onChange={(e) => setDate(e.target.value)} />
          </div>
          <Row>
            <div style={{ flex: 1 }}>
        ...
        <Container>
          ...
          <FormCard>
            ...
            <div>
              ...
              <FormSection>
                <Label>강의 제목</Label>
                <Input type="text" placeholder="진행할 실시간 강의 제목을 입력해 주세요" />
              </FormSection>
              {/* 강의 설명 */}
              <FormSection>
                <Label>강의 설명</Label>
                <TextArea rows={7} placeholder="진행할 실시간 강의 내용을 입력해 주세요" />
              </FormSection>
              {/* 강의 목록 */}
              <FormSection>
                <Label>강의 목록</Label>
              ...
              <FormSection>
                <Row>
                  <div style={{ flex: 1 }}>
                    <Label>가격</Label>
                    <Input type="text" placeholder="예: 10000" />
